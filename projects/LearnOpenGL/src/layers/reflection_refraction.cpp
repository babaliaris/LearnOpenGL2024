#include "reflection_refraction.h"
#include "cameraFunctionalityLayer.h"

namespace LearnOpenGL
{
    ReflectionRefraction::ReflectionRefraction(Application *app)
    ...
    ReflectionRefraction::~ReflectionRefraction()
    {
        delete m_shader;
    ...
    void ReflectionRefraction::onStart(Application *app)
    {
    ...
    void ReflectionRefraction::onUpdate(Application *app)
    {
    ...
    void ReflectionRefraction::PrepareCubeData()
    {
        float vertices[] = {
            // Back face
    ...
    void ReflectionRefraction::PrepareSkyboxData()
    {
        float vertices[] = {
            // positions
            -1.0f,  1.0f, -1.0f,
    ...
    void ReflectionRefraction::RenderCube()
    {
        glCALL(glBindVertexArray(m_vaoCube));
    ...
    void ReflectionRefraction::RenderSkybox()
    {
        glCALL(glBindVertexArray(m_vaoSkybox));
        m_skyBox->Bind(0);
