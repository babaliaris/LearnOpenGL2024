...
{
    Blending::Blending(Application *app)
    ...
    void Blending::onStart(Application *app)
    {
    ...
    void Blending::onUpdate(Application *app)
    {
    ...
    void Blending::PreparePlaneData()
    {
        float vertices[] = {
            // positions          // normals           // texture coords
    ...
    void Blending::RenderPlane(bool isGrass)
    {
        glCALL(glBindVertexArray(m_vaoPlane));
