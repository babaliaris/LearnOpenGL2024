...
{
    Antializing::Antializing(Application *app)
    : Layer("Antializing", app), m_vaoCube(0), m_vboCube(0),
        m_app(app)
    {
    ...
    void Antializing::onUpdate(Application *app)
    {
    ...
    void Antializing::PrepareCubeData()
    {
        float vertices[] = {
            // Back face
    ...
    void Antializing::PrepareSkyboxData()
    {
        float vertices[] = {
            // positions
            -1.0f,  1.0f, -1.0f,
    ...
    void Antializing::RenderReflectRefractCube(const glm::mat4 model,
